...
const PokeCard = (props) => {
    ...
    let styles = {
        ...
        gradient_bg_normal: "linear-gradient(to top left, rgba(169, 169, 169, 0.95), rgba(169, 169, 169, 0.92))",
        gradient_bg_fire: "linear-gradient(to top left, rgba(238, 129, 48, 0.95), rgba(238, 129, 48, 0.92))",
        gradient_bg_water: "linear-gradient(to top left, rgba(99, 144, 240, 0.95), rgba(99, 144, 240, 0.92))",
        gradient_bg_electric: "linear-gradient(to top left, rgba(247, 208, 44, 0.95), rgba(247, 208, 44, 0.92))",
        gradient_bg_grass: "linear-gradient(to top left, rgba(122, 199, 76, 0.95), rgba(122, 199, 76, 0.92))",
        gradient_bg_ice: "linear-gradient(to top left, rgba(150, 217, 214, 0.95), rgba(150, 217, 214, 0.92))",
        gradient_bg_fighting: "linear-gradient(to top left, rgba(194, 46, 40, 0.95), rgba(194, 46, 40, 0.92))",
        gradient_bg_poison: "linear-gradient(to top left, rgba(163, 62, 161, 0.95), rgba(163, 62, 161, 0.92))",
        gradient_bg_ground: "linear-gradient(to top left, rgba(226, 191, 101, 0.95), rgba(226, 191, 101, 0.92))",
        gradient_bg_flying: "linear-gradient(to top left, rgba(169, 143, 243, 0.95), rgba(169, 143, 243, 0.92))",
        gradient_bg_psychic: "linear-gradient(to top left, rgba(249, 85, 135, 0.95), rgba(249, 85, 135, 0.92))",
        gradient_bg_bug: "linear-gradient(to top left, rgba(166, 185, 26, 0.95), rgba(166, 185, 26, 0.92))",
        gradient_bg_rock: "linear-gradient(to top left, rgba(182, 161, 54, 0.95), rgba(182, 161, 54, 0.92))",
        gradient_bg_ghost: "linear-gradient(to top left, rgba(115, 87, 151, 0.95), rgba(115, 87, 151, 0.92))",
        gradient_bg_dragon: "linear-gradient(to top left, rgba(111, 53, 252, 0.95), rgba(111, 53, 252, 0.92))",
        gradient_bg_dark: "linear-gradient(to top left, rgba(112, 87, 70, 0.95), rgba(112, 87, 70, 0.92))",
        gradient_bg_steel: "linear-gradient(to top left, rgba(183, 183, 206, 0.95), rgba(183, 183, 206, 0.92))",
        gradient_bg_fairy: "linear-gradient(to top left, rgba(214, 133, 173, 0.95), rgba(214, 133, 173, 0.92))",
